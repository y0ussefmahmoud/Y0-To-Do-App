...
![Version](https://img.shields.io/badge/Version-3.2.6-66BB6A)
...
- 💾 **ميزة النسخ الاحتياطي**: إضافة آلية تصدير واستعادة البيانات (Backup & Restore)
...
- 📤 **مشاركة النسخ الاحتياطي**: مشاركة ملف النسخ الاحتياطي عبر share_plus (WhatsApp, Email, Google Drive, إلخ)
- 🗂️ **تحسين النماذج**: إضافة toJson/fromJson methods لـ Task و SearchHistory لدعم النسخ الاحتياطي
- 🧹 **تنظيف المشروع**: إزالة الملفات غير المفيدة (flutter clean, حذف UI_UX_Design_Brief القديم)
- 📱 **إعادة الشاشة الكلاسيكية**: إعادة إضافة home_screen.dart كخيار تصميم بديل
...
## الجديد في الإصدار v3.2.5
- 🛡️ **حل مشكلة null cast error**: إصلاح خطأ type Null is not a subtype عند التحديث من النسخ القديمة
- 🔄 **Migration Logic**: إضافة منطق ترحيل تلقائي للبيانات القديمة بدون فقدان البيانات
- 🔧 **تحسين معالجة الأخطاء**: تحسين error handling في settings_provider و app_settings
- ✅ **خلو من الأخطاء**: flutter analyze يظهر "No issues found!"
- 🎯 **تقليل تعقيد الدوال**: تحسين قابلية القراءة في home_screen_neomorphic.dart

## الجديد في الإصدار v3.2.4
