...
Future<void> main() async {
  ...
  ErrorHandler.logInfo('Starting Y0 To-Do App v3.4.0 initialization');
  ...
  try {
    ...
    try {
      ...
      ErrorHandler.logInfo('Checking RecurrenceRuleAdapter registration...');
      if (!Hive.isAdapterRegistered(5)) {
        Hive.registerAdapter(RecurrenceRuleAdapter());
        ErrorHandler.logInfo('RecurrenceRuleAdapter registered successfully.');
      }

      ErrorHandler.logInfo('Checking RecurrenceFrequencyAdapter registration...');
      if (!Hive.isAdapterRegistered(9)) {
        Hive.registerAdapter(RecurrenceFrequencyAdapter());
        ErrorHandler.logInfo('RecurrenceFrequencyAdapter registered successfully.');
      }

      ErrorHandler.logInfo('Checking SubTaskAdapter registration...');
      if (!Hive.isAdapterRegistered(6)) {
        Hive.registerAdapter(SubTaskAdapter());
        ErrorHandler.logInfo('SubTaskAdapter registered successfully.');
      }
